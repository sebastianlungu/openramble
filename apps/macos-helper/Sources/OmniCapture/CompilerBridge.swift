...
final class CompilerBridge: CompilerBridgeProtocol {
    ...
    private static let repoRootEnvKey = "OMNICAPTAIN_REPO_ROOT"
    private static let repoRootBundleKey = "OmniCaptureRepoRoot"
    ...
    private static func commonHomeRepoCandidates() -> [String] {
        ...
        return [
            "\(home)/omnicaptain",
            "\(home)/Code/omnicaptain",
            "\(home)/Developer/omnicaptain",
            "\(home)/Projects/omnicaptain"
        ]
    }
